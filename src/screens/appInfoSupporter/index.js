...
import OnBoardSupporter1Light from '@/assets/svg/Light/OnBoardSupporter1Light.svg'
import OnBoardSupporter2Light from '@/assets/svg/Light/OnBoardSupporter2Light.svg'
import OnBoardSupporter3Light from '@/assets/svg/Light/OnBoardSupporter3Light.svg'

import OnBoardSupporter1Dark from '@/assets/svg/Dark/OnBoardSupporter1Dark.svg'
import OnBoardSupporter2Dark from '@/assets/svg/Dark/OnBoardSupporter2Dark.svg'
import OnBoardSupporter3Dark from '@/assets/svg/Dark/OnBoardSupporter3Dark.svg'
...
const AppInfoSupporterScreen = props => {
  ...
  const carouselItemData = [
    {
      svg: theme === "dark" ? (<OnBoardSupporter1Dark width={250} height={250} />) : (<OnBoardSupporter1Light width={250} height={250} />),
      titleText: getVal("on_board_supporter_1_title"),
      descText: getVal("on_board_supporter_1_desc")
    },
    {
      svg: theme === "dark" ? (<OnBoardSupporter2Dark width={250} height={250} />) : (<OnBoardSupporter2Light width={250} height={250} />),
      titleText: getVal("on_board_supporter_2_title"),
      descText: getVal("on_board_supporter_2_desc")
    },
    {
      svg: theme === "dark" ? (<OnBoardSupporter3Dark width={250} height={250} />) : (<OnBoardSupporter3Light width={250} height={250} />),
